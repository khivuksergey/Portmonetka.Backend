...
import { AddCategory, ErrorAlert, Popper } from "../../Components";
...
import { IconPlus, IconRemoveRow, IconRestoreRow } from "../../Common/Icons";
...
export default function TransactionsPage() {
    ...
    const getInitialTemplates = () => {
        ...
        // const res: TAddTemplatesType = {
        //     templates: [
        //         { description: "Тест", categoryId: 38, amount: "-461", isNew: false, isDeleted: false },
        //         { description: "Тест 2", categoryId: 43, amount: "", isNew: false, isDeleted: false }
        //     ]
        // };
        // return res;
    };
    ...
    useEffect(() => {
        setShowError(!!templatesError && templatesError !== "Component unmounted");
    }, [templatesError])
    ...
    return (
        <>
            <ErrorAlert showError={showError} onClose={() => setShowError(false)} error={templatesError} />
                        ...
                        <>
                            <Form onSubmit={handleSubmit} autoComplete="off" noValidate>
                                                            ...
                                                            >
                                                                    ...
                                                                    <InputGroup className="mb-3">
                                                                        {
                                                                            !values.templates[i].isDeleted ?
                                                                                <button type="button" className="button--dark button--delete" onClick={() => handleDeleteRow(remove, i, values, setFieldValue)}>
                                                                                    <IconRemoveRow size={20} fill="darkgrey" />
                                                                                </button>
                                                                                :
                                                                                <button type="button" className="button--dark button--restore" onClick={() => handleRestoreRow(i, values, setFieldValue)}>
                                                                ...
                                                                <Col xs={isScreenSizeLessThan300 ? 12 : 8} sm={4}>
                                                                    <InputGroup className="mb-3" >
                                                                        ...
                                                                        >
                                                                            <IconPlus fill="darkgrey" className="pointer-events-none" />
                                                                        </button>
                                                                        <Form.Select
                                ...
                                <div className="mt-3 d-flex flex-row gap-3 justify-content-end">
                                    {/* <button type="reset" className="button--dark"
